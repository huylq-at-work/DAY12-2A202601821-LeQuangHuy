...
class CostGuard:
    ...
    def spent(self, user_id: str, month: str | None = None) -> float:
        ...
        # Key chưa tồn tại → None. User chưa tiêu gì không phải là lỗi.
        if raw is None:
            return 0.0
        return float(raw)  # Redis luôn trả chuỗi
    ...
    def record(self, user_id: str, cost: float, month: str | None = None) -> float:
        ...
        # incrbyfloat là atomic: nhiều instance cùng cộng vào một user cũng
        # không mất mát như đọc-rồi-ghi.
