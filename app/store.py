...
class ConversationStore:
    ...
    def ping(self) -> bool:
        ...
        try:
            ...
            # /ready gọi hàm này; nó không được ném lỗi, nếu không probe sập
            # thay vì báo "chưa sẵn sàng". Redis chết = not ready, không phải crash.
            return False
    ...
    def append(self, user_id: str, role: str, content: str) -> None:
        ...
        # Chỉ giữ HISTORY_MAX_MESSAGES tin gần nhất — prompt phình = tiền token phình.
        self.client.ltrim(key, -HISTORY_MAX_MESSAGES, -1)
        # Hội thoại cũ tự hết hạn, khỏi dọn tay và khỏi để Redis đầy dần.
