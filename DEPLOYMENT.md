...
| Mã học viên | 2A202601821 |
| Repo | https://github.com/huylq-at-work/DAY12-2A202601821-LeQuangHuy |
...
| `REDIS_URL` | ✅ | Redis plugin của Railway, tham chiếu biến `${{ Redis.REDIS_URL }}` |
...
Deploy trên Railway — không dùng phương án dự phòng.
